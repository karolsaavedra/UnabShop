...
fun RegisterScreen(onClickBack: ()-> Unit = {}, onSuccessfulRegister: () -> Unit = {}) {
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                value = inputName,
                onValueChange = {inputName= it}, //el it es para que se pueda escribir
                label = { Text("Nombre") },
                leadingIcon = {
            ...
            Button(
                onClick = {
                    ...
                    val isValidConfirmPassword = validateConfirmPassword(inputPassword, inputPasswordConfirmation).first //crear y confirmar contraseña
